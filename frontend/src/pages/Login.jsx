...
export default function Login({ onLoginSuccess }) {
  ...
  return (
    <div className="min-h-screen w-full bg-background bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/10 via-background to-background flex items-center justify-center p-4">
      {/* Decorative glows */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-violet-500/5 rounded-full blur-3xl" />

      <Card className="w-full max-w-md border-border/80 shadow-2xl relative overflow-hidden backdrop-blur-xl">
          ...
          <CardContent className="space-y-4 pt-6">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <a href="#forgot" className="text-[10px] text-primary hover:underline">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
